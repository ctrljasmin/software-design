...
namespace lab7
{
    public partial class Form1 : Form
    {
        ...
        private async void btnSearchBook_Click_1(object sender, EventArgs e)
        {
        ...
        private async void btnExportBooks_Click_1(object sender, EventArgs e)
        {
        ...
        private async void btnImportBooks_Click_1(object sender, EventArgs e)
        {
        ...
        private async void btnAddBook_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Both book title and author name are required.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
